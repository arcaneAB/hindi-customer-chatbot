...
cnt = 0
with open('Data/data_sentences.txt', 'r',encoding="utf8") as f:
    for line in f:
        cnt = cnt + 1
        if cnt == 1:
            topic = line
...
with open('Data/data_roots.txt', 'r',encoding="utf8") as f:
    for line in f:
        roots.append(line.split("\n")[0])

with open('Data/data_pos_tags.txt', 'r',encoding="utf8") as f:
    for line in f:
        pos_tags.append(line.split("\n")[0])

with open('Lemmatizer/stop_words.txt', 'r',encoding="utf8") as f:
    for line in f:
